  ...
  const classes = useStyles();
    ...
    {forecastArray.filter(daily => {
      ...
      ? output = {
          ...
          icon: <img className='weather-icon2' src={`http://openweathermap.org/img/wn/${conditions}@2x.png`} alt="weather-icon" />,
        ...
        <>
          <React.Fragment>
            ...
            <Grid item xs={4}>
              ...
              <Paper className={classes.weather2}>{output.max}° / {output.min}°</Paper>
